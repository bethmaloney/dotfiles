...
# ZSH_THEME="powerlevel10k/powerlevel10k"  # disabled - using starship
ZSH_THEME=""
...
# [[ ! -f ~/.p10k.zsh ]] || source ~/.p10k.zsh  # disabled - using starship
...
source ~/.nvm/nvm.sh
export PATH="$PATH:/home/beth/.dotnet/tools"
